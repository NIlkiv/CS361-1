...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		// EMPLOYEE
		// PART TIME EMPLOYEE
		// because of function overriding. 
		// emp3.getHourlyRate(); 
		// returns syntax error because hourlyRate is a private parameter in class PartTimeEmployee
		...
		// because downcasting an object to its sub class type would generate confusion. 
